...
class AppDatabase(context: Context) : SQLiteOpenHelper(
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        db.execSQL("CREATE INDEX IF NOT EXISTS idx_conn_created ON connections(created_at)")
        db.execSQL("CREATE INDEX IF NOT EXISTS idx_conn_uid ON connections(uid)")
    }
    ...
    companion object {
        ...
        fun getInstance(context: Context): AppDatabase {
            return INSTANCE ?: synchronized(this) {
                ...
                val instance = ctx.let { AppDatabase(it) }
                INSTANCE = instance
                instance
            }
        }
